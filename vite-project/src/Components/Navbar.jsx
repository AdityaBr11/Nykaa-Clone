                ...
                <Link to="#">
                  <div className="d">
                    ...
                    <div className="d-content b-content">
                      <div
                        className="row text-xs font-thin"
                        style={{ backgroundColor: "white", zIndex: "inherit" }}
                      >
            ...
            {detial.length == 0 ? (
              <Menu>
                ...
                <MenuList float={"left"} width={21} p={2}>
                  <MenuGroup>
                    <Heading fontSize={20} fontWeight={400} m={"8px 0"}>
                ...
                <Box>
                  <Menu>
                    ...
                    <MenuList width={100} p={2}>
                      <MenuGroup>
                        <Heading fontSize={30} fontWeight={400} m={"8px 0"}>
                          {e.name}
                        </Heading>
                        <Text fontSize={10} p={5}>
                          <b>{e.email}</b>
                        </Text>
