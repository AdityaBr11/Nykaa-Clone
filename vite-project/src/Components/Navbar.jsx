                                ...
                                <DrawerContent>
                                    ...
                                    <DrawerBody mt={20}>
                                        <Container maxW={'lg'} alignItems={'center'}>
                                            ...
                                            <Heading fontSize={22} m={'15px 0px'} textAlign='center'>Your Shopping Bag is Empty</Heading>
                                            <Text fontSize={15} m={'15px 0px'} textAlign='center'>This feels too light! Go on, add all your favourites</Text>
                                            <Box w={'35%'} m='10px auto'>
                                          ...
                                          { verfiy ?"": <Box border={"1px solid lightgray"} w='100%' borderRadius={5} p='5px' mt={3}>
                                            ...
                                            <Box border={"1px solid lightgray"} w='100%' borderRadius={5} p='1px' mt={3}>
                                                <Box display={'flex'} gap={2} w='100%' borderRadius={5} p='1px' mt={3}>
                                                    ...
                                                    <Text color={'#d5418e'} p={4} fontSize={25}><RiDeleteBin6Line /></Text>
                                                </Box>
                                                <hr />
                                                <Box display={'flex'} justifyContent={'space-between'}>
                                                    ...
                                                    <Box display={'flex'}>
                                                        <Text p={'8px 8px'} fontWeight={500} textDecoration='line-through' color={'lightgray'}>₹{Price}</Text>
                                                        <Text p={'8px 8px'} fontWeight={500}>₹{offerPrice}</Text>
                                                    </Box>
                                                </Box>
                                            </Box>
